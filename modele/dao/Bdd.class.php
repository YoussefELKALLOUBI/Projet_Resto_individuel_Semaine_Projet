...
class Bdd {
    ...
    private static $login = "elkalloubi";   // login utilisateur de la BDD
    private static $mdp = "77OVK";         // mdp  utilisateur de la BDD
    private static $bd = "elkalloubi_resto2";          // nom de la BDD
